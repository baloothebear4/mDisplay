...
Test module to develop an http error handler for errant Radio websites
...
To add a release to a collection or remove one:
	...
	'baloothebear4', 'meWzuh-katfyn-6qadqu')
"""
...
def find_musicbrainz_art(artist,album):
    data     = musicbrainzngs.search_artists(artist=artist, type="group",)
    # print("Search_artist")
    # print_data(data)
    print("search_release_groups")
    data = musicbrainzngs.search_release_groups(artist + ' ' + album)
    print_data(data)

    # imagebin = musicbrainzngs.get_image_front(id)
    print("")

def coverart_test(release_id):
    data = musicbrainzngs.get_image_list("46a48e90-819b-4bed-81fa-5ca8aa33fbf3")
    print(data, '\n')
...
def print_data(d):
    """ structured print of a complex dict """
...
if __name__ == '__main__':
    ...
    if args:
        ...
        # print("cover_art")
        # coverart_test("46a48e90-819b-4bed-81fa-5ca8aa33fbf3")

        print("find art")
        find_musicbrainz_art('Jean-Michel Jarre', 'Oxygene')
